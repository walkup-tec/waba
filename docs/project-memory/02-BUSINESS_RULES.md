...
- Laboratório Cloud: BODY Utility com léxico **Olá** + **Informamos que** + **Para** e uma âncora de utilidade (**confirmação**, **status confirmado**, **confirmado**, **aprovado**, **concluído**, **atualizado**, **liberado**). Botões só **Ver Detalhes**, **Saiba Mais**, **Ver Atualizações**. A categoria final é da Meta.
