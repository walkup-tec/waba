...
- A foto de perfil do chip no Laboratório pode ser ditada no Waba e enviada à Meta (`profile_picture_handle`). O nome de exibição continua sujeito a aprovação da Meta.
