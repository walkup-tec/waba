...
- Webhook Cloud `statuses` atualiza o disparo (`wamid`) e, após janela quieta, fecha o relatório da campanha vinculada. Docs: https://developers.facebook.com/docs/whatsapp/cloud-api/webhooks/components
