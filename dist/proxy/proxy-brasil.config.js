...
exports.parseProxyBrasilCompact = parseProxyBrasilCompact;
exports.loadProxyBrasilConfig = loadProxyBrasilConfig;
exports.proxyBrasilPublicSummary = proxyBrasilPublicSummary;
...
function parseProtocol(raw) {
    ...
    if (v === "https" || v === "socks4" || v === "socks5" || v === "http")
        return v;
    return "http";
}
/** host:port:user:password (password pode conter ':') */
function parseProxyBrasilCompact(raw) {
...
function proxyBrasilPublicSummary(cfg) {
    if (!cfg) {
