...
const PUBLIC_MESSAGES = {
    ...
    template_url_https: "Informe a URL de destino com http:// ou https://. O sistema gera o link curto do nosso domínio para a Meta.",
    template_url_restricted: "A Meta recusou o host do botão. O cadastro precisa usar o link curto do nosso domínio, não wa.me nem whatsapp.com.",
    template_shorten_failed: "Não foi possível gerar o link curto no nosso domínio. Tente novamente em instantes.",
    ...
    template_upload_failed: "Não foi possível enviar o arquivo da mídia para a Meta. Para imagem, use JPEG ou PNG e tente novamente.",
