...
exports.normalizeCloudApiRecipient = normalizeCloudApiRecipient;
exports.normalizeTemplateLanguage = normalizeTemplateLanguage;
/**
 * Destinatário Cloud API (E.164 sem +).
 * Não acrescenta DDI, nono dígito nem 55. Não altera o número em silêncio.
 */
function normalizeCloudApiRecipient(input) {
