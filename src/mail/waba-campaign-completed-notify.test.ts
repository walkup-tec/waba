...
import { buildCampaignCompletedTemplate, buildCampaignCompletedWhatsAppText } from "./waba-mail.templates";
...
describe("aviso de campanha finalizada", () => {
  ...
  it("o print de VITORIA DA CONQUISTA leva a linha do tempo e os indicadores pedidos", () => {
    const html = buildCampaignReportSnapshotHtml(buildVitoriaCompletedNotifySnapshot());
    assert.match(html, /VITORIA DA CONQUISTA/);
